...
<div class="auth">
  ...
  <div id="adm-link" style="text-align:center;margin-top:16px;<?= $err?'display:none':'' ?>">
    <a href="#" onclick="document.getElementById('adm').style.display='block';this.parentElement.style.display='none';return false" style="font-size:12px;color:var(--muted)">Masuk dengan email</a>
  </div>
  <div id="adm" style="<?= $err?'':'display:none' ?>;margin-top:14px">
